...
<body>
    ...
    <main class="px-4">
        <h1 class="text-center p-3">Data Mahasiswa</h1>
        <?php
        if ($sukses) {
        ?>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="input-mahasiswa.php?NIM=<?php echo $r1['NIM'] ?>" class="text-decoration-none">
                                <span class="badge bg-warning text-dark tombol">Edit</span>
                            </a>
                            <a href="mahasiswa.php?op=delete&id=<?php echo $r1['NIM'] ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')">
