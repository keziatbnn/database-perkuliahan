...
if ($op == 'delete') {
    $KodeMatkul = $_GET['id'];
    $sql1 = "delete from Mata Kuliah where KodeMatkul = '$KodeMatkul'";
...
<body>
    ...
    <main class="px-4">
        <h1 class="text-center p-3">Data Mata Kuliah</h1>
        <?php
        if ($sukses) {
        ?>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $r1['NamaMatkul'] ?></td>
                        <td><?php echo $r1['SKS'] ?></td>
                        <td><?php echo $r1['Semester'] ?></td>
                        <td>
                            <a href="input-mk.php?KodeMatkul=<?php echo $r1['KodeMatkul'] ?>" class="text-decoration-none">
                                <span class="badge bg-warning text-dark tombol">Edit</span>
                            </a>
                            <a href="matakuliah.php?op=delete&id=<?php echo $r1['KodeMatkul'] ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')">
