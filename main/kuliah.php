...
if ($op == 'delete') {
    $IDKuliah = $_GET['id'];
    $sql1 = "delete from Kuliah where IDKuliah = '$IDKuliah'";
...
<body>
    ...
    <main class="px-4">
        <h1 class="text-center p-3">Data Kuliah</h1>
        <?php
        if ($sukses) {
        ?>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $r1['IDKuliah'] ?></td>
                        <td><?php echo $r1['NIM'] ?></td>
                        <td><?php echo $r1['NIP'] ?></td>
                        <td><?php echo $r1['KodeMatkul'] ?></td>
                        <td><?php echo $r1['Nilai'] ?></td>
                        <td>
                            <a href="input-kuliah.php?IDKuliah=<?php echo $r1['IDKuliah'] ?>" class="text-decoration-none">
                                <span class="badge bg-warning text-dark tombol">Edit</span>
                            </a>
                            <a href="kuliah.php?op=delete&id=<?php echo $r1['IDKuliah'] ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')">
